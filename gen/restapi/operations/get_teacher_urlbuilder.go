...
func (o *GetTeacherURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on GetTeacherURL")
	}
...
func (o *GetTeacherURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetTeacherURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetTeacherURL")
	}
